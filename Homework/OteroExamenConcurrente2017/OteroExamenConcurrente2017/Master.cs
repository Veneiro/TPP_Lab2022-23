...
namespace Lab09
{
    ...
    public class Master
    {
        ...
        public Master(double[] vector, double[] vector2, int numberOfThreads, int value)
        {
        ...
        public double ComputeModulus()
        {
            ...
            {
                workers[i] = new Worker(this.vector, this.vector2,
                    i * elementsPerThread,
        ...
        public double ComputeModulus2()
        {
            ...
            for (int i = 0; i < workers.Length; i++)
            {
                ...
                threads[i] = new Thread(workers[i].CalculateDistanceF);
                threads[i].Name = "Worker Vector Modulus " + (i + 1);
                threads[i].Priority = ThreadPriority.BelowNormal;
                threads[i].Start();
            }
