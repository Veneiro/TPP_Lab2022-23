...
namespace lab01TPP
{
    ...
    internal class SinglyLinkedList
    {
        ...
        /// <summary>
        /// Integer with the count of elements that are contained in the list
        /// </summary>
        ...
        /// <returns> A Node representing the node in that index </int></returns>
        ...
        /// <summary>
        /// Returns the node of a given indesx
        /// </summary>
        /// <param name="index">Index to be checked</param>
        /// <returns>A Node that is in the index provided </returns>
        private Node getNode(int index)
        {
            int pos = 0;
            Node node = head;
