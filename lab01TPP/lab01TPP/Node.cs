...
namespace lab01TPP
{
    ...
    internal class Node
    {
        ...
        /// <summary>
        /// The node Node which is in the next position
        /// </summary>
        private Node next;
        ...
        /// Get the next node
        /// </summary>
        /// <returns> A Node with the next node in the list </returns>
        public Node GetNext()
        {
            return next;
        }
        ...
        /// Set the next node
        /// </summary>
        /// <param name="next"> The Node you want to be the next </param>
